"""
FastAPI REST API Server for Anc Absolute Neutrophil Calculator.
"""
...
app = FastAPI(
    title="Anc Absolute Neutrophil Calculator API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "anc-absolute-neutrophil-calculator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
