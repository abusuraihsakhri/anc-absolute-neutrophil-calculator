"""
Automated Pytest for anc-absolute-neutrophil-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    EnrichmentmdEngine,
    LongitudinalAncTrendTrackingEngine,
    ...
    AncabsoluteneutrophilcalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = AncabsoluteneutrophilcalculatorEnrichmentSuite()
